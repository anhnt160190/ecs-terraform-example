locals {
  ...
  ecr_name               = "api-users"
  ecs_task_role_arn      = "arn:aws:iam::6152012730594:role/prod-demo-task-role"
  service_name           = "api-users"
  ecs_cluster_arn        = "arn:aws:ecs:ap-southeast-1:6152012730594:cluster/prod-demo"
  ...
  secret_manager_arn     = "arn:aws:secretsmanager:ap-southeast-1:6152012730594:secret:prod-api-users-sSZCnP"
  container_port         = 4000
  rule_priority          = 1
